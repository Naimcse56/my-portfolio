            ...
            <div class="border p-3 rounded">
               ...
               <form class="row g-3" method="POST" action="{{ route('services.update', $service->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" id="icon" name="icon" value="{{$service->icon}}" required>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Short Details</label>
                        <textarea class="form-control" type="text" id="short_details" name="short_details" required>{{$service->short_details}}</textarea>
                    </div>
                    <div class="col-12">
                        <div class="d-grid">
