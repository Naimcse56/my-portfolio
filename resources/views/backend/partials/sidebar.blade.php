   ...
   <div class="iconmenu">
      ...
      <ul class="nav nav-pills flex-column">
         ...
         <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Blogs">
            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-blog" type="button"><i class="bi bi-pencil-square"></i></button>
         </li>
      </ul>
   </div>
   <div class="textmenu">
      ...
      <div class="tab-pane fade" id="pills-blog">
         <div class="list-group list-group-flush">
            ...
            <a href="{{route('blogs.index')}}" class="list-group-item"><i class="bi bi-pencil-square"></i>Blog List</a>
         </div>
      </div>
      </div>
   </div>
